---
title: "Token Fields: Configuring Your BEP-20 Token"
...
<ParamField body="Total Supply" type="integer" required>
  ...
  **Best practice:** Think carefully about your supply in relation to your project. A very large supply (e.g. trillions of tokens) combined with a low price per token is a common pattern, but there is no formula that works for every project. The total supply is fixed at deployment unless your contract includes mint functionality — standard Teron contracts may allow the owner to mint additional tokens after deployment.
</ParamField>
