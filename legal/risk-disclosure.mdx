---
title: "Teron Risk Disclosure — BEP-20 Tokens on BNB Chain"
sidebarTitle: "Risk Disclosure"
description: "A full disclosure of the risks involved in creating and using BEP-20 tokens on BNB Chain through the Teron platform. Effective August 10, 2026."
---
...
<Warning>
  Nothing in this document constitutes financial or legal advice. You are solely responsible for your decisions when creating, holding, or trading digital tokens.
</Warning>
...
<Warning>
  If you lose your private key or seed phrase, your tokens and contracts may be permanently inaccessible. Teron cannot recover them for you.
</Warning>
...
<Note>
  Always double-check the recipient address, amount, and network before confirming any transaction in your wallet. Confirmed transactions cannot be reversed.
</Note>
